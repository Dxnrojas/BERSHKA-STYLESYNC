...
export default function renderEmailNotificationScreen({ outfitId }) {
  ...
  const outfitImages = {
    1: "https://kjuzyqehmpbpoderrumf.supabase.co/storage/v1/object/...",
    2: "https://kjuzyqehmpbpoderrumf.supabase.co/storage/v1/object/...",
    3: "https://kjuzyqehmpbpoderrumf.supabase.co/storage/v1/object/..."
  };
